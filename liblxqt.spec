...
Version  : 1.2.0
Release  : 12
URL      : https://github.com/lxqt/liblxqt/releases/download/1.2.0/liblxqt-1.2.0.tar.xz
Source0  : https://github.com/lxqt/liblxqt/releases/download/1.2.0/liblxqt-1.2.0.tar.xz
Source1  : https://github.com/lxqt/liblxqt/releases/download/1.2.0/liblxqt-1.2.0.tar.xz.asc
...
%prep
%setup -q -n liblxqt-1.2.0
cd %{_builddir}/liblxqt-1.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667853671
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/liblxqt-%{version}/COPYING %{buildroot}/usr/share/package-licenses/liblxqt/7fab4cd4eb7f499d60fe183607f046484acd6e2d || :
pushd clr-build
%make_install
popd
...
/usr/share/lxqt/translations/liblxqt/liblxqt_et.qm
...
/usr/share/lxqt/translations/liblxqt/liblxqt_hi.qm
...
/usr/share/lxqt/translations/liblxqt/liblxqt_si.qm
